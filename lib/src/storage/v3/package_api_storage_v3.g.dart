...
_PackageApiStorageV3 _$PackageApiStorageV3FromJson(
  ...
  executableDeclarations: (json['executableDeclarations'] as List<dynamic>)
      .map(
        (e) =>
            ExecutableDeclarationStorageV3.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  fieldDeclarations: (json['fieldDeclarations'] as List<dynamic>)
      .map((e) => FieldDeclarationStorageV3.fromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  minSdkVersion: const VersionJsonConverter().fromJson(
    json['minSdkVersion'] as String,
  ),
  packageDependencies: (json['packageDependencies'] as List<dynamic>)
      .map(
        (e) => PackageDependencyStorageV3.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
...
Map<String, dynamic> _$PackageApiStorageV3ToJson(
  ...
  'minSdkVersion': const VersionJsonConverter().toJson(instance.minSdkVersion),
