...
void main() {
  group('test_package_return_type_changes', () {
    ...
    group('return type narrowing (should be non-breaking)', () {
      ...
      setUpAll(() async {
        diffResult = PackageApiDiffer().diff(
          oldApi: await packageWithWideReturns.analyzePrepared(),
          newApi: await packageWithNarrowReturns.analyzePrepared(),
        );
      });
    ...
    group('return type widening (should be breaking)', () {
      ...
      setUpAll(() async {
        diffResult = PackageApiDiffer().diff(
          oldApi: await packageWithNarrowReturns.analyzePrepared(),
          newApi: await packageWithWideReturns.analyzePrepared(),
        );
      });
