...
void main() {
  group('test_package_widening_types', () {
    ...
    group('widening types', () {
      ...
      setUpAll(() async {
        diffResult = PackageApiDiffer().diff(
          oldApi: await packageAWithNarrowTypes.analyzePrepared(),
          newApi: await packageAWithWiderTypes.analyzePrepared(),
        );
      });
    ...
    group('narrowing types', () {
      ...
      setUpAll(() async {
        diffResult = PackageApiDiffer().diff(
          oldApi: await packageAWithWiderTypes.analyzePrepared(),
          newApi: await packageAWithNarrowTypes.analyzePrepared(),
        );
      });
